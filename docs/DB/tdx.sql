...
(
    ...
    `code`            varchar(6) COLLATE utf8mb4_general_ci                        NOT NULL COMMENT '板块代码',
    ...
    PRIMARY KEY (`id`),
    KEY               `idx_code` (`code`) USING BTREE COMMENT '板块code'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='板块/指数-实时行情（以 tdx 为准）';
...
(
    ...
    `gmt_modify`      datetime                                                     NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    PRIMARY KEY (`id`),
    KEY               `idx_code` (`code`) USING BTREE COMMENT '股票code'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='股票-实时行情';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='股票-板块 关联';