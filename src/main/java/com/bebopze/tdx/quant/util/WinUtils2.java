...
public class WinUtils2 {
    ...
    public static List<HWND> findWindowList(String lpClassName,
                                            String lpWindowName) {
        ...
        User32.INSTANCE.EnumWindows(new WNDENUMPROC() {
            ...
            @Override
            public boolean callback(HWND hwnd,
                                    Pointer arg) {
     ...
     */
    public static List<HWND> listAllChildButton(String lpClassName,
                                                String lpWindowName) {
...
//    }
    ...
    public static List<HWND> listAllChildWin(HWND hwnd) {
        ...
        User32.INSTANCE.EnumChildWindows(hwnd, new WNDENUMPROC() {
            ...
            @Override
            public boolean callback(HWND hwndChild,
                                    Pointer arg) {
